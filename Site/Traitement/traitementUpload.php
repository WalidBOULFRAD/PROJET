<?php
	...
	$target_dir = "../Vue/images/Plan/".$id."/".$type."/";

	$oldName = basename($_FILES["photo"]["name"]);
	$target_file = $target_dir.$oldName;

	$uploadOk = 1;
	$imageFileType = pathinfo($target_file,PATHINFO_EXTENSION);

	$nvName = time().".".$imageFileType;
	$target_file = $target_dir.$nvName;
	...
	if (file_exists($target_file)) {
	    ...
	    echo "<script>window.location = '../Affichages/PhotosUpload.php';</script>";
	    $uploadOk = 0;
	}
